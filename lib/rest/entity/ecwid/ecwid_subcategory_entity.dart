...
class EcwidSubCategoryEntity extends Persistent{
  EcwidSubCategoryEntity({
    this.id,
    this.parentId,
    this.orderBy,
    this.hdThumbnailUrl,
  ...
  factory EcwidSubCategoryEntity.fromJson(Map<String, dynamic> json) => EcwidSubCategoryEntity(
