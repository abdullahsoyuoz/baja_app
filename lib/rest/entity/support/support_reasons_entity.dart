...
class SupportReasonEntity extends Persistent{
  SupportReasonEntity({
    this.id,
    this.name,
    this.supports,
  ...
  factory SupportReasonEntity.fromJson(Map<String, dynamic> json) => SupportReasonEntity(
    id: json["id"] == null ? null : json["id"],
    name: json["name"] == null ? null : json["name"],
    supports: json["supports"] == null ? null : List<Support>.from(json["supports"].map((x) => Support.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "id": id == null ? null : id,
    "name": name == null ? null : name,
    "supports": supports == null ? null : List<dynamic>.from(supports.map((x) => x.toJson())),
  };
}
