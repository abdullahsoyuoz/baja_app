...
class BajaExpressEntity {
  ...
  final int price;
  final int priceInProductList;
  final int defaultDisplayedPrice;
  ...
  factory BajaExpressEntity.fromJson(Map<String, dynamic> json) => BajaExpressEntity(
    ...
    subscriptionSettings: json["subscriptionSettings"] == null ? null : SubscriptionSettings.fromJson(json["subscriptionSettings"]),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "subscriptionSettings": subscriptionSettings == null ? null : subscriptionSettings.toJson(),
...
class Shipping {
  ...
  factory Shipping.fromJson(Map<String, dynamic> json) => Shipping(
    ...
    enabledMethods: json["enabledMethods"] == null ? null : List<String>.from(json["enabledMethods"].map((x) => x)),
  );
...
class SubscriptionSettings {
  SubscriptionSettings({
    ...
    this.oneTimePurchaseAllowed,
    this.recurringChargeSettings,
  });

  final bool subscriptionAllowed;
  final bool oneTimePurchaseAllowed;
  final List<RecurringChargeSetting> recurringChargeSettings;
  ...
  factory SubscriptionSettings.fromJson(Map<String, dynamic> json) => SubscriptionSettings(
    ...
    oneTimePurchaseAllowed: json["oneTimePurchaseAllowed"] == null ? null : json["oneTimePurchaseAllowed"],
    recurringChargeSettings: json["recurringChargeSettings"] == null ? null : List<RecurringChargeSetting>.from(json["recurringChargeSettings"].map((x) => RecurringChargeSetting.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "subscriptionAllowed": subscriptionAllowed == null ? null : subscriptionAllowed,
    "oneTimePurchaseAllowed": oneTimePurchaseAllowed == null ? null : oneTimePurchaseAllowed,
    "recurringChargeSettings": recurringChargeSettings == null ? null : List<dynamic>.from(recurringChargeSettings.map((x) => x.toJson())),
  };
}

class RecurringChargeSetting {
  RecurringChargeSetting({
  ...
  factory RecurringChargeSetting.fromJson(Map<String, dynamic> json) => RecurringChargeSetting(
    recurringInterval: json["recurringInterval"] == null ? null : json["recurringInterval"],
    recurringIntervalCount: json["recurringIntervalCount"] == null ? null : json["recurringIntervalCount"],
  );

  Map<String, dynamic> toJson() => {
    "recurringInterval": recurringInterval == null ? null : recurringInterval,
    "recurringIntervalCount": recurringIntervalCount == null ? null : recurringIntervalCount,
  };
}
